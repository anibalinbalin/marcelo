/**
 * CENT / Grupo SBF E2E using the local 4Q25 source workbook.
 *
...
const QUARTER = "4Q25";
const SOURCE_URL =
  "https://rnsbkyuol74lbgv8.public.blob.vercel-storage.com/reports/2/4Q25/Planilha%20Interativa%204T25-7LfPLVXVGfqU1qYOOCvhUyyyLU1Zme.xlsx";
...
async function main() {
  ...
  try {
    ...
    const approved = await approveValues(run.id, "e2e-cent@local", []);
